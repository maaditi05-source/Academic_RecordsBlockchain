...
export ORDERER1_HOST="${ORDERER1_HOST:-100.65.71.102}"
...
export ORDERER2_HOST="${ORDERER2_HOST:-100.88.165.33}"
...
export ORDERER3_HOST="${ORDERER3_HOST:-100.102.112.54}"
...
export NITW_PEER0_HOST="${NITW_PEER0_HOST:-100.93.235.38}"
...
export NITW_PEER1_HOST="${NITW_PEER1_HOST:-100.102.67.29}"
...
export NITW_PEER2_HOST="${NITW_PEER2_HOST:-100.73.161.99}"
...
export DEPT_CSE_HOD_HOST="${DEPT_CSE_HOD_HOST:-100.103.144.78}"
...
export DEPT_CSE_FAC_HOST="${DEPT_CSE_FAC_HOST:-100.118.136.16}"
...
export DEPT_ECE_HOD_HOST="${DEPT_ECE_HOD_HOST:-100.75.175.30}"
...
export DEPT_ECE_FAC_HOST="${DEPT_ECE_FAC_HOST:-100.101.132.58}"
...
export VERI_PEER0_HOST="${VERI_PEER0_HOST:-100.123.15.33}"
...
export VERI_PEER1_HOST="${VERI_PEER1_HOST:-100.79.122.76}"
