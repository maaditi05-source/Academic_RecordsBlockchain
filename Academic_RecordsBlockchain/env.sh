...
export ORDERER1_HOST="${ORDERER1_HOST:-172.20.242.77}"
...
export ORDERER2_HOST="${ORDERER2_HOST:-172.20.233.222}"
...
export DEPT_CSE_HOD_HOST="${DEPT_CSE_HOD_HOST:-172.20.247.9}"
...
export DEPT_CSE_FAC_HOST="${DEPT_CSE_FAC_HOST:-172.20.252.32}"
...
export DEPT_ECE_HOD_HOST="${DEPT_ECE_HOD_HOST:-172.20.244.81}"
