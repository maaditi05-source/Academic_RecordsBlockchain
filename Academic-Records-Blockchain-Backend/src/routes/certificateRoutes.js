...
// Update certificate request status (Admin/Faculty/HOD/DAC/Dean/Exam)
router.put('/requests/:requestId', authenticateToken, requireRole('admin', 'faculty', 'hod', 'dac_member', 'dean_academic', 'exam_section'), CertificateController.updateCertificateRequestStatus);
